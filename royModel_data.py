...
T = [Task(0.8, 0.8, 1.1, 0.1),	#1
	Task(0.8, 0.1, 1.3, 0.1),		#2
	Task(0.3, 0.1, 0.8, 0.1),	#3
	Task(0.8, 0.1, 0.9, 0.1),		#4
	Task(0.3, 0.1, 0.9, 0.1),	#5
	Task(0.1, 0.3, 0.9, 0.1),	#6
	Task(0.1, 0.2, 0.9, 0.1),	#7
	Task(0.6, 0.3, 0.9, 0.1),		#8
	Task(0.1, 0.4, 0.9, 0.05),	#9
	Task(0.1, 0.3, 0.9, 0.05),	#10
	Task(0.1, 0.2, 0.9, 0.05),	#11
	Task(0.1, 0.4, 0.9, 0.05),	#12
	]
